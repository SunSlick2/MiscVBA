...
' ── Constants ────────────────────────────────────────────────────────────────
Private Const CP_PATH  As String = "C:\Users\YOUR_USERNAME\"
Private Const DP_PATH  As String = "C:\Users\YOUR_USERNAME\"
...
Public Sub RunContTRF()
    ...
    Set dictCP = LoadCPDictionary(wsCP, colMapCP)
...
Private Sub SynchroniseCPwithDP(ByVal wsCP As Worksheet, _
                                  ...
                                  ByVal formulaTemplates() As String, _
...
Private Sub WriteNewRows(ByVal wsCP As Worksheet, _
                          ByVal colMapCP As Object, _
                          ByVal formulaTemplates() As String, _
                          ByVal newRowsData() As Variant, _
